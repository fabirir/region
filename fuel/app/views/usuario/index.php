                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <h2>Cauca:Popayan</h2>
                                <p>Lugar cercano a Rosas en el que se pueden apreciar diferentes paisajes</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  Santiago Ramirez | Arlex Galindez Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
