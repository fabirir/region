   ...
   <section class="hero">
      <div class="container">
         <div class="hero__slider owl-carousel">
            ...
            ?>
               <div class="hero__items set-bg" data-setbg="<?php echo $lugar['imagen']; ?>">
                  <div class="row">
                     <div class="col-lg-6">
      ...
      <div class="container">
         <div class="anime__details__content">
            ...
            ?>
               ...
               <div class="row">
                  <div class="col-lg-3">
                     <div class="anime__details__pic set-bg" data-setbg="<?php echo $lugar['imagen']; ?>"> </div>
                  </div>
                  <div class="col-lg-9">
                     <div class="anime__details__text">
                        <div class="anime__details__title">
                           <h3>Nombre: <?php echo $lugar['nombre']; ?></h3>
                           <span>Ubicacion: <?php echo $lugar['ubicacion']; ?></span>
                        </div>
                        <p>Entrada: <?php echo $lugar['entrada']; ?></p>
                     </div>
                  </div>
               </div>
            <?php
