      ...
      <div class="container">
         <div class="anime__details__content">
            ...
            ?>
               ...
               <div class="row">
                  <div class="col-lg-3">
                     <div class="anime__details__pic set-bg" data-setbg="<?php echo $plato['imagen']; ?>"> </div>
                  </div>
                  <div class="col-lg-9">
                     <div class="anime__details__text">
                        <div class="anime__details__title">
                           <h3>Nombre: <?php echo $plato['nombre']; ?></h3>
                           <span>Ingredientes: <?php echo $plato['ingredientes']; ?></span>
                        </div>
